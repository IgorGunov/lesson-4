package ru.mirea.gunovigor.thread;
...
import ru.mirea.gunovigor.thread.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainThread.setName("МОЙ НОМЕР ГРУППЫ: БСБО-03-20, НОМЕР ПО СПИСКУ: 9, МОЙ ЛЮБИИМЫЙ ФИЛЬМ: 1+1");
